<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SignUp.aspx.cs" Inherits="Seller_SignUp" %>
...
<body>
    ...
    <div class="form-row">
                            <div class="form-group col-md-6"> <label for="tbfn">Name</label>
                                <br />
                            ...
                            <div class="form-group col-md-6"> <label for="tbphno">Phone Number</label>
                                <br />
    ...
    <div class="form-group"> <label for="tbacnt">Account Number</label>
        <br />
        <asp:TextBox ID="tbacnt" runat="server" class="form-control" placeholder="Ex: 0021789561254"></asp:TextBox>
        </div>
                        <div class="row">
                            <div class="form-group col-md-6"><label for="tbifsc">IFSC</label>
                                <br />
                                <asp:TextBox ID="tbifsc" runat="server" class="form-control" placeholder="Ex: HDFC0051012"></asp:TextBox>
                            </div>
                            <div class="form-group col-md-6"> <label for="tbgstin">GSTIN</label>
                                <br />
                                <asp:TextBox ID="tbgstin" runat="server" class="form-control" placeholder="Ex: 22pan875151z5"></asp:TextBox>
                                <br />
                                <%--<asp:RegularExpressionValidator ID="vgstin" runat="server"  ControlToValidate="tbgstin" ValidationExpression="^([0]{1}[1-9]{1}|[1-2]{1}[0-9]{1}|[3]{1}[0-7]{1})([a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}[1-9a-zA-Z]{1}[zZ]{1}[0-9a-zA-Z]{1})+$" ErrorMessage=<small class="form-text text-dange" Display="Dynamic" >Enter valid GSTIN</small></asp:RegularExpressionValidator>--%>
